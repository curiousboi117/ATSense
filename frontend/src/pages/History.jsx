...
export default function History() {
  ...
  const handleDownloadPDF = async (id, filename) => {
    try {
      ...
      link.href = url;
      link.download = `${filename || 'ATSense_Report'}.pdf`;
  ...
  const handleDelete = async (resumeId, e) => {
    ...
    if (
      window.confirm(
        'Are you sure you want to delete this resume version and all associated analysis records?'
      )
    ) {
    ...
    <div className="max-w-5xl mx-auto px-4 py-12 space-y-6">
      ...
      {history.length === 0 ? (
        <div className="max-w-md mx-auto text-center py-16">
          <GlassCard
            hover={false}
            className="border-sky-500/10 p-8 space-y-4"
          >
            ...
            >
              ...
              <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end border-t md:border-none border-white/5 pt-4 md:pt-0">
                ...
                <div className="text-left md:text-right shrink-0">
                  ...
                  <p className="text-lg font-extrabold text-sky-400 font-outfit">
                    {item.ats_score}/100
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-slate-800 border border-white/5 hover:bg-slate-700 text-slate-300 transition-colors cursor-pointer"
                    title="Download PDF"
                  >
